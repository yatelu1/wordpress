...
?>
	<div class="commenthead new">
    
   
            
              <span><?php echo get_comment_author_link();?></span>
        
        发布于 &nbsp;&nbsp;<?php echo mysql2date('Y.m.d H:i', $c->comment_date);?><a name='comment-<?php echo $c->comment_ID ?>'></a>
            
            
            </div>
			<div class="body">			<?php if(function_exists('get_avatar'))echo get_avatar($c->comment_author_email, '50'); ?>
