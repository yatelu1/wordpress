...
<!--  container -->
<div id="container">
<div id="lead">您的位置：<a href="<?php bloginfo('url'); ?>">首页</a> > <?php bloginfo('description'); ?> </div>
	<?php if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
				...
				<div class="entry">
					...
					<span class="continue"><a href="<?php the_permalink() ?>" rel="bookmark" title="进入 <?php the_title(); ?>">阅读全文</a></span>
