...
<div class="clear"></div>
<div class="info">作者：<?php the_author() ?> | 分类：<?php the_category(', ') ?> | 阅读：<?php post_views('', '次'); ?> | <?php the_tags('标签：', ', ', ''); ?></div><div class="comments_num"><?php comments_popup_link ('抢沙发','1条评论','%条评论'); ?></div>
