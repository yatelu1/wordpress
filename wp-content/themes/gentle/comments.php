...
<?php endif; ?>
	...
	<div id="respond">
		...
		$fields = array(
					...
					'url' => '<p class="contact-url"><input type="text" name="url" id="url" value="Website" size="22" tabindex="3" class="website_f" onfocus="if(this.value==\'Website\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'Website\';"/></p></div>'
			);
			...
			$defaults = array(
				...
				'id_form'              => 'commentform',
				'id_submit'            => 'submit',
				'title_reply'          => __( 'Leave a Comment', 'gentle' ),
				'title_reply_to'       => __( 'Leave a Reply to %s', 'gentle' ),
				'cancel_reply_link'    => __( '- cancel reply', 'gentle' ),
				'label_submit'         => __( 'Post Comment', 'gentle' ),
